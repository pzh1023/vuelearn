...
declare const TimePicker: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "size" | "disabled" | "popupVisible" | "defaultPopupVisible" | "position" | "unmountOnClose" | "type" | "error" | "readonly" | "allowClear" | "format" | "disableConfirm" | "use12Hours" | "hideDisabledOptions">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
