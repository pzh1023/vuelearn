...
declare const TreeSelect: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "disabled" | "popupVisible" | "defaultPopupVisible" | "border" | "multiple" | "data" | "error" | "allowClear" | "loading" | "allowSearch" | "fallbackOption" | "selectable" | "labelInValue" | "treeCheckable" | "treeCheckStrictly" | "treeCheckedStrategy" | "disableFilter">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
