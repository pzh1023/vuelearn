...
declare const Tag: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "visible" | "loading" | "closable" | "defaultVisible" | "checked" | "checkable" | "defaultChecked">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
