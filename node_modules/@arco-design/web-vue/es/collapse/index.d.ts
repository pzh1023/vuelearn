...
declare const Collapse: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "bordered" | "activeKey" | "defaultActiveKey" | "accordion" | "expandIconPosition" | "destroyOnHide">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
